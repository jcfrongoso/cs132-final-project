...
<div class="max-w-5xl mx-auto">
    ...
    <h3 class="mb-2">Univariate Analysis</h3>
    <p class="mb-4"></p>
    

    <h4 class="mb-2">Species</h4>
    ...
    <h3 class="mb-2">Bivariate Analysis</h3>
    <p class="mb-4"></p>
    

    <h4 class="mb-2">Species - Value</h4>
    <img alt="Placeholder" class="w-1/6" src={bi_species_value} />
    <p class="mb-4"></p>

    <h4 class="mb-2">Species - Volume</h4>
    <img alt="Placeholder" class="w-1/6" src={bi_species_volume} />
    <p class="mb-4"></p>

    <h4 class="mb-2">Geolocation - Value</h4>
    <img alt="Placeholder" class="w-1/6" src={bi_geolocation_value} />
    <p class="mb-4"></p>

    <h4 class="mb-2">Geolocation - Volume</h4>
    <img alt="Placeholder" class="w-1/6" src={bi_geolocation_volume} />
    <p class="mb-4"></p>

    <h4 class="mb-2">Value - Year/Quarter</h4>
    <img alt="Placeholder" class="w-1/6" src={bi_value_yearquarter} />
    <p class="mb-4"></p>
    
    <h4 class="mb-2">Volume - Year/Quarter</h4>
    <img alt="Placeholder" class="w-1/6" src={bi_volume_yearquarter} />
    <p class="mb-4"></p>
    
    <h4 class="mb-2">Value - Volume</h4>
    <img alt="Placeholder" class="w-1/6" src={bi_value_volume} />
    <p class="mb-4"></p>
    
    
    <!-- Multivariate Analysis -->
    
    <h3 class="mb-2">Multivariate Analysis</h3>
    <p class="mb-4"></p>


    <h4 class="mb-2">Value - Year/Quarter per Species</h4>
    <img alt="Placeholder" class="w-1/6" src={multi_value_species} />
    <p class="mb-4"></p>
    
    <h4 class="mb-2">Value - Year/Quarter per Region</h4>
    <img alt="Placeholder" class="w-1/6" src={multi_value_region} />
    <p class="mb-4"></p>
    
    <h4 class="mb-2">Volume - Year/Quarter per Species</h4>
    <img alt="Placeholder" class="w-1/6" src={multi_volume_species} />
    <p class="mb-4"></p>
    
    <h4 class="mb-2">Volume - Year/Quarter per Region</h4>
    <img alt="Placeholder" class="w-1/6" src={multi_volume_region} />
    <p class="mb-4"></p>
    ...
    <div>
        ...
        <p  class="mb-2">Our first research question focuses on the significance of these two values in determining our support for aquaculture systems in the Philippines. With proper knowledge and analysis of these features, we get to understand the position of aquaculture systems in our country. We can use this knowledge to identify what key points lead to the increase/decrease of these systems in order to maintain a stable economy.</p>
        <p  class="mb-2">For the first research question, we are dealing with a quantitative independent variable Volume and a quantitative dependent variable Value. Given this, we opted to use linear regression to identify the correlation between the two variables. Using StatsModels API on Ordinary Least Squares, we were able to identify the following results.</p>
        <p  class="mb-2">insert results here</p>
        <p  class="mb-2">Given the summary results provided from our OLS regression, we conclude that we should reject the null hypothesis with $P > |t|$, t-statistic value of 37.296 which is large, and with the 95% confidence interval [0.015, 0.016] not including zero which means that there is a positive correlation between the two.</p>
    </div>
    <div>
    ...
    <h3 class="mb-2">Data Modeling</h3>
    
    <h3 class="mb-2">Nutshell Graph</h3>
</div>