...
<div class="max-w-5xl mx-auto">
    ...
    <div>
        ...
        <p class="mb-2">After using the Scipy method `f_oneway`, we get that an F value of 45 and a p value of 3.25 × 10<sup>−135</sup> which are relatively small so we reject the null hypothesis. Given this, we can say that **there is a significant difference in aquaculture volume across different regions in the Philippines**.</p>
        <h3>IMPLICATIONS</h3>
