...
<div class="max-w-5xl mx-auto">
    ...
    <div>
        ...
        <img alt="Placeholder" class="w-xl" src='images/plots/4-1 Relationship between Production Volume and Economic Value.png' />
        <h2>IMPLICATIONS</h2>
        ...
        <img alt="Placeholder" class="w-xl" src='images/plots/4-1 KMeans Clustering.png' />
        ...
        <img alt="Placeholder" class="w-xl" src='images/plots/4-1 Kmeans with regression lines.png' />
    ...
    <div>
        ...
        <img alt="Placeholder" class="w-xl" src='images/plots/4-2 Production Volume by Region.png' />
...
- Potential instability in food security, especially if future volumes fluctuate unexpectedly, affecting local consumption and export goals.</p>
        ...
        <img alt="Placeholder" class="w-xl" src='images/plots/4-3 Production Volume Over The Years.png' />
        <img alt="Placeholder" class="w-xl" src='images/plots/4-3 Production Volume Over the Years by Region.png' />
    </div>
    
    <h3 class="mb-2">What's our take?</h3>
    <img alt="Placeholder" class="w-5xl" src='images/plots/5 Nutshell plot.png' />
    <p>
