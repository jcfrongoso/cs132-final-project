...
<div class="max-w-5xl mx-auto">
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={uni_volume_histogram} />
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={uni_value_boxplot} />
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={uni_value_boxplot_no_outlier} />
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={uni_value_distribution} />
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={bi_species_value_total} />
    <p class="mb-4">
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={bi_species_value_mean} />
    <p class="mb-4">
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={bi_species_volume_total} />
    <p class="mb-4">
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={bi_geolocation_value_mean} />
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={bi_value_yearquarter_1} />
    <p class="mb-4">
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={bi_volume_yearquarter} />
    <p class="mb-4">
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={bi_value_volume} />
    <p class="mb-4">
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={multi_value_species_dist} />
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={multi_value_species_trend} />
    ...
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={multi_value_region_trend} />
    <img alt="Placeholder" class="h-96 my-8 mx-auto" src={multi_value_region_dist} />
